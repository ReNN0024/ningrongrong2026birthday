...
### Changed
- 全局碎片位置调整：将 8_1「时光的河入海流」移至 4_3，原 4_3~7_4 依次后移一位（循环位移）
- 涉及 15 个碎片位置（4_3~8_1），素材文件、officialNames、偏移配置、文档全量同步
- 各碎片的 logo/名称/原图映射关系不变

## [1.14.1] - 2026-09-12

### Added
- 新增碎片 `7_4`「梦里仍见旧乡」（Logo 24KB / 原图 361KB），有效碎片增至 32 个，第 7 行已满

## [1.14.0] - 2026-09-12

### Added
- 新增碎片 `7_3`「再来一瓶到天明」（Logo 25KB / 原图 95KB），有效碎片增至 31 个

## [1.13.0] - 2026-09-05

### Fixed
- 移动端（Android/微信 WebView）待选碎片区高度异常膨胀，导致坐标轴被推出屏幕
- 根因：`dvh` 单位在不支持的浏览器中失效，回退到桌面 `height: 100%` 导致容器撑开
- 修复：为所有移动端 `dvh` 声明添加 `vh` 回退（渐进增强）

## [1.12.3] - 2026-09-05

### Changed
- 删除引导区文案"把 41 份碎片，放进她的故事里。"

## [1.12.2] - 2026-09-05

### Fixed
- 修复 styles.css 中未解决的 git 合并冲突标记导致清空确认弹窗蒙层丢失的问题 (by coze)

## [1.12.1] - 2026-09-05

### Added
- 碎片解锁测试参数：URL 加 `?unlock=all` 绕过时间锁展示全部碎片，支持 `?unlock=数字` 指定解锁索引 (by coze)

## [1.12.0] - 2026-09-05

### Added
- 碎片分批时间解锁：北京时间 9/20 零点解锁 4_4~6_3、9/27 零点解锁 6_4~9_1、9/28 21:00 解锁全部；此前仅展示 1_1~4_3；库面板与计数同步跟随解锁范围 (by coze)

## [1.11.6] - 2026-09-05

### Added
- 新增 8_4「没有偷吃啦」碎片（icon + 原图 + 命名），icon 23KB RGBA 透明，原图 154KB (by coze)

## [1.11.5] - 2026-09-05

### Added
- 新增 8_2「共婵娟」碎片（icon + 原图 + 命名），icon 26KB RGBA 透明，原图 327KB (by coze)

## [1.11.4] - 2026-09-05

### Added
- 新增 8_1「时光的河入海流」碎片（icon + 原图 + 命名），icon 20KB RGBA 透明，原图 110KB (by coze)

## [1.11.3] - 2026-09-05

### Changed
- 碎片「再加九克好奇心」从槽位 8_1 迁移至 8_3：交换素材文件、更新 officialNames 索引、同步偏移配置 LOGO_QUADRANT_OFFSETS 键名 8_1→8_3 (by coze)

## [1.11.2] - 2026-09-05

### Added
- 新增 6_2「入世」碎片（icon + 原图 + 命名），icon 21KB RGBA 透明，原图 168KB (by coze)

## [1.11.1] - 2026-09-05

### Added
- 新增 6_1「风起青萍之末」碎片（icon + 原图 + 命名），icon 20KB RGBA 透明，原图 238KB (by coze)

## [1.11.0] - 2026-09-05

### Added
- 新增 5_2「公主巡察时」碎片（icon + 原图 + 命名），icon 22KB RGBA 透明，原图 104KB (by coze)

## [1.10.9] - 2026-08-27

### Added
- 新增 4_2「花」碎片（icon + 原图 + 命名），icon 20KB RGBA 透明，原图 582KB (by coze)

## [1.10.8] - 2026-08-27

### Added
- 新增 4_1「冠」碎片（icon + 原图 + 命名），icon 24KB RGBA 透明，原图 345KB (by coze)

## [1.10.7] - 2026-08-27

### Added
- 新增 3_4「何人消隐于风声」碎片（icon + 原图 + 命名），icon 18KB RGBA 透明，原图 122KB (by coze)

## [1.10.6] - 2026-08-27

### Added
- 新增 2_4「已收款三块五」碎片（icon + 原图 + 命名），icon 22KB RGBA 透明，原图 135KB (by coze)

## [1.10.5] - 2026-08-27

### Added
- 新增 2_3「珠如雨」碎片（icon + 原图 + 命名），icon 21KB RGBA 透明，原图 211KB (by coze)

## [1.10.4] - 2026-08-27

### Added
- 新增 1_2「韶光慢」碎片（icon + 原图 + 命名），icon 18KB RGBA 透明，原图 191KB (by coze)
