...
"与我周旋久" —— 宁荣荣 2026 生日庆典预热活动的双端响应式 H5 页面。用户可在坐标系中拖放碎片素材，支持撤销/重做、缩放平移、自动保存与恢复。当前共 19 个有效碎片（另有 15 个占位、10 个空槽，合计 44 个槽位）。
...
- `app.js`：核心逻辑模块
  - 素材数据管理（19 个有效碎片 + 25 个占位/空槽，slot 命名规则 `行_列`）
...
### 碎片对照表（以线上 officialNames 为准，共 19 个有效碎片）
...
**空槽位**（无素材文件）：`2_3` `2_4` `3_4` `4_1` `4_2` `5_2` `11_1`-`11_4`（共 10 个）
