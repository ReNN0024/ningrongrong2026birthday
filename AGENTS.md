...
- `app.js`：核心逻辑模块
  - 素材数据管理（27 个有效碎片 + 17 个占位/空槽，slot 命名规则 `行_列`）
...
### 碎片对照表（以线上 officialNames 为准，共 27 个有效碎片）
...
| `6_2` | 入世 | assets/logos/6_2.webp (21KB) | assets/detail-images/6_2.webp (168KB) |
...
**占位槽位**（有 ~1KB 占位图标，无碎片名称）：`7_3` `7_4` `8_2` `8_3` `8_4` `9_1`-`9_4` `10_1`-`10_4`（共 13 个）
