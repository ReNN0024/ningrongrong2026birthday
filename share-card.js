(() => {
  ...
  const LOGO_QUADRANT_OFFSETS = {
    ...
    "2_2": { x: 0.5, y: 0 },   // 知晓我在的人：X 轴分界右移至 0.5
    "3_1": { x: 0.5, y: -1 },  // 冲调午后：X 分界右移 0.5，Y 分界下移 -1
    "3_2": { x: 0.5, y: -1 },  // 左满舵：X 分界右移 0.5，Y 分界下移 -1
    "3_3": { x: 0.5, y: -1 },  // 槐花冰奶七分糖：X 分界右移 0.5，Y 分界下移 -1
    "4_3": { x: -1, y: 1 },    // 暝夜：X 分界左移 -1，Y 分界上移 1
    "4_4": { x: 1, y: 0 },     // 心动瞬间：X 轴分界右移至 1
    "5_1": { x: -1, y: 1 },    // 莲花去国一千年：X 分界左移 -1，Y 分界上移 1
    "5_3": { x: 1, y: 0 },     // 引梦渡海：X 轴分界右移至 1
    "5_4": { x: -1, y: 0 },    // 海落潮升：X 轴分界左移至 -1
    "6_3": { x: 1, y: 0 },     // 现实童话：X 轴分界右移至 1
    "7_1": { x: 1, y: 0 },     // 伴生：X 轴分界右移至 1
    "7_2": { x: 0.5, y: 0 },   // 直到世界听到：X 轴分界右移至 0.5
