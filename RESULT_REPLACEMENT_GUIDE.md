...
|---|---|---|---|
| 第三象限：荆棘 × 寻常（x < 0，y < 0） | **R**estrained | 蓝色 `blue` / `#E2F0F8` | <img src="assets/share-card-figures/r-lineart-green.webp" width="90" alt="R线稿裁切-绿色"> |
| 第二象限：荆棘 × 不忘（x < 0，y > 0） | **O**rthodox | 粉色 `pink` / `#FAE9EF` | <img src="assets/share-card-figures/n-lineart-blue.webp" width="90" alt="N线稿裁切-蓝色"> |
| 第一象限：繁花 × 不忘（x > 0，y > 0） | **N**uminous | 黄色 `yellow` / `#F8F0D8` | <img src="assets/share-card-figures/o-lineart-yellow.webp" width="90" alt="O线稿裁切-黄色"> |
| 第四象限：繁花 × 寻常（x > 0，y < 0） | **G**entle | 绿色 `green` / `#E7F3E7` | <img src="assets/share-card-figures/g-lineart-pink.webp" width="90" alt="G线稿裁切-粉色"> |
