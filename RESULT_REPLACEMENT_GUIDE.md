...
| 第二象限：荆棘 × 不忘（x < 0，y > 0） | **O**rthodox | 粉色 `pink` / `#FAE9EF` | <img src="assets/share-card-figures/o-lineart-pink.webp" width="90" alt="O线稿裁切-粉色"> |
...
| 第四象限：繁花 × 寻常（x > 0，y < 0） | **G**entle | 绿色 `green` / `#E7F3E7` | <img src="assets/share-card-figures/g-lineart-green.webp" width="90" alt="G线稿裁切-绿色"> |
